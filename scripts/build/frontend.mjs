...
function renderIndexHtml({ cssHref, appHref }) {
...
await esbuild.build({
  ...
  minify,
  define: {
    __BA_AI_SDK_BRIDGE_URL__: JSON.stringify(bridgeModuleHref),
  },
  banner: {
    js: "/* AUTO-GENERATED by scripts/build/frontend.mjs. Do not edit directly. */",
  },
  plugins: [toolDefinitions],
  logLevel: "silent",
});
