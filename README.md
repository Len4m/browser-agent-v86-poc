...
[![Versión beta](https://img.shields.io/badge/version-0.9.2--beta.1-orange)](https://github.com/Len4m/browser-agent-v86-poc)
...
Estado actual: **beta `0.9.2-beta.1`**. La versión `1.0.0` queda reservada para la primera publicación estable.
...
- Autor: Lenam [lenam@protonmail.com](mailto:lenam@protonmail.com) ([https://Len4m.github.io](https://Len4m.github.io))
