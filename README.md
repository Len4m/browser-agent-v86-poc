...
[![Beta version](https://img.shields.io/badge/version-0.9.8--beta.7-orange)](https://github.com/Len4m/browser-agent-v86-poc)
...
Current status: **beta `0.9.8-beta.7`**. Version `1.0.0` is reserved for the first stable release.
