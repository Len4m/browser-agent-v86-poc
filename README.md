...
[![Beta version](https://img.shields.io/badge/version-0.9.7--beta.2-orange)](https://github.com/Len4m/browser-agent-v86-poc)
...
Current status: **beta `0.9.7-beta.2`**. Version `1.0.0` is reserved for the first stable release.
