...
[![Versión beta](https://img.shields.io/badge/version-0.9.7--beta.1-orange)](https://github.com/Len4m/browser-agent-v86-poc)
...
Estado actual: **beta `0.9.7-beta.1`**. La versión `1.0.0` queda reservada para la primera publicación estable.
...
| [docs/ARCHITECTURE.es.md](docs/ARCHITECTURE.es.md) | ES | Arquitectura frontend, build, VM, seriales, LLM y reglas de mantenimiento. |
