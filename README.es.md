...
[![Versión beta](https://img.shields.io/badge/version-0.9.7--beta.2-orange)](https://github.com/Len4m/browser-agent-v86-poc)
...
Estado actual: **beta `0.9.7-beta.2`**. La versión `1.0.0` queda reservada para la primera publicación estable.
